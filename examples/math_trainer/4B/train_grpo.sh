...
TOTAL_EPOCHS=30
TRAIN_DATASET=("datasets/simplelr_math_35/train_new")
VALID_DATASET=("datasets/deepscaler/aime" "datasets/deepscaler/aime25")
...
WANDB_API_KEY="${WANDB_API_KEY:-}" # Modify your wandb key
