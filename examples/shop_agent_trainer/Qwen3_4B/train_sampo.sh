...
MODEL=UCLA-SCAI/Qwen3-4B-rft-webshop
MODEL_SHORT="${MODEL##*/}"
...
for seed in 0
do
    experiment_name="${MODEL_SHORT}_SAMPO_final_len_${max_response_length}_format_error_kl"
    ...
    python3 -m recipe.shop_agent.main_shop_agent_final \
        ...
        algorithm.filter_groups.cold_start_steps=5 \
